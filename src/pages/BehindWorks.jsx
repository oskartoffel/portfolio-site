...
const BehindWorks = () => {
  ...
  const tabContent = [
    ...
    // Content for the "What is the project now?" tab
    {
      title: "What is the project now?",
      content: (
        <>
          <h3 style={{ 
            fontFamily: 'Tahoma, Arial, sans-serif',
          ...
          <div style={{
            ...
            <ul style={{ 
              ...
              <li><strong>Growth & Aging:</strong> Each tree goes through a cycle of growing taller and heavier every year.</li>
            ...
            <ul style={{ 
              ...
              <li><strong>Population Growth:</strong> Deer reproduce at a rate that depends on factors like food availability and herd density.</li>
            ...
            <ul style={{ 
              ...
              <li><strong>Predation:</strong> Wolves rely on deer as their food source, hunting in packs for higher success rates.</li>
    ...
    {
      title: "Where could the project lead to?",
      content: (
        <>
          <h3 style={{ 
            fontFamily: 'Tahoma, Arial, sans-serif',
            ...
            Where could the project lead to?
          </h3>
          <p style={{ 
            fontFamily: 'Tahoma, Arial, sans-serif',
            fontSize: '14px',
